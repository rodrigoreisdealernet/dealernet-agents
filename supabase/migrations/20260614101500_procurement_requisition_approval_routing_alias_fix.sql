-- ---------------------------------------------------------------------------
-- Procurement requisition approval routing follow-up fix
--
-- Additive-only migration that replaces function definitions to qualify
-- requisition_id references and avoid PL/pgSQL variable/column ambiguity.
-- ---------------------------------------------------------------------------
