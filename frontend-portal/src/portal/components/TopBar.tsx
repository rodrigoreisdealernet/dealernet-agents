    ...
    <header className="flex h-14 shrink-0 items-center gap-2 border-b border-header-border bg-header px-3 text-header-foreground">
      ...
      <div className="ml-auto flex items-center gap-1">
        ...
        <DropdownMenu.Root>
          <DropdownMenu.Trigger
            title={t('language')}
            className="flex h-8 items-center rounded-md px-2 text-white/80 outline-none transition-colors hover:bg-white/10 hover:text-white data-[state=open]:bg-white/10"
          >
