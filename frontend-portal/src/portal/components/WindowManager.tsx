...
function EmptyState() {
  return (
    <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center gap-4 text-center">
      ...
      <div>
        <p className="text-base font-semibold text-foreground">Sua área de trabalho está vazia</p>
        <p className="mt-1 max-w-xs px-6 text-sm text-muted-foreground">
          Abra uma tela pelo menu lateral. Você pode empilhar, organizar em cascata e salvar como workspace.
        </p>
      </div>
    </div>
  )
