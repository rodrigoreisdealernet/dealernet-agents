...
create_label "release-notes"       "0e8a16" "Nightly release-notes + marketing PR (Release Notes Curator)"
...
create_label "auto:trend"          "5319e7" "Cross-ticket trend roll-up raised by the Trend Analyst"

echo "--- Discovery pipeline labels (docs/discovery) ---"
create_label "discovery:signal"       "d4c5f9" "Discovery: raw market signal"
create_label "discovery:opportunity"  "c5b3f0" "Discovery: framed problem/opportunity"
create_label "discovery:idea"         "b8a2ec" "Discovery: proposed solution with a stated bet"
create_label "discovery:validated"    "8a63d2" "Discovery: validated (set by discovery-critic only)"
create_label "discovery:ready"        "5319e7" "Discovery: design-ready, awaiting owner go/no-go (critic only)"
create_label "needs-more-evidence"    "fbca04" "Discovery: kicked back by the critic for more evidence"
create_label "agentic-opportunity"    "0e8a16" "Has a strong agentic-workflow angle (see docs/agentic-charter.md)"
create_label "operating-model"         "1d76db" "Epic generated from the operating model (docs/discovery/domain)"
...
create_label "shared-file-overlap" "b60205" "PR shares changed files with another open PR — merge blocked until sequenced"
